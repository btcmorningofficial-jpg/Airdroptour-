...
class _CriptoAdminState extends State<CriptoAdmin> {
  ...
  void initState() {
    ...
    AdminServices.getExchangeLinks(context);
  }
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      listenable: Listenable.merge([
        AdminServices.criptoList,
        AdminServices.exchangeLinksAdminList,
      ]),
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: bold("Borsa Linkleri"),
              ),
              Column(children: AdminServices.exchangeLinksAdminList.value),
              GestureDetector(
                onTap: () {
                  AdminServices.addExchangeLink(context);
                },
                child: Opacity(
                  opacity: 0.5,
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [bold("Add New Exchange Link")],
                    ),
                  ),
                ),
              ),
